      ...
      const listaZapatos = document.querySelector("#lista-carrito-sobreZapaton tbody");
      //boton
      const vaciarCarritoBtn = document.getElementById("vaciar-carrito-sobreZapaton");
...
function leerLocalStorage(){
    ...
    zapatosLS.forEach(function(zapato){
        ...
        <td> ${zapato.titulo}</td>
        <td> ${zapato.precio}</td>
        <td> <a href="#" class="borrar-general borrar-producto-sobreZapaton" data-id="${zapato.id}">X</a>
        </td>`
        ;
...
function eliminarZapato(e){
    ...
    if (e.target.classList.contains("borrar-producto-sobreZapaton")){
