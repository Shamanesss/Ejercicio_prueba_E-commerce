      ...
      const listaZapatos = document.querySelector("#lista-carrito-cuenta tbody");
      //boton
      const vaciarCarritoBtn = document.getElementById("vaciar-carrito-cuenta");
...
function leerLocalStorage(){
    ...
    zapatosLS.forEach(function(zapato){
        ...
        <td> ${zapato.titulo}</td>
        <td> ${zapato.precio}</td>
        <td> <a href="#" class="borrar-general borrar-producto-cuenta" data-id="${zapato.id}">X</a>
        </td>`
        ;
...
function eliminarZapato(e){
    ...
    if (e.target.classList.contains("borrar-producto-cuenta")){
